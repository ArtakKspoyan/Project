        ...
        <div class="content">
			<div class="container">
				...
				<div class="_1adminOverveiw_table_recent _box_shadow _border_radious _mar_b30 _p20">
					<p class="_title0">User<Button @click="addModal = true"><Icon type="md-add" />Add admin</Button></p>
	...
	methods : {
		async addAdmin(){
			...
			if(res.status===201){
				...
				this.s('Admin has been added sucsefully!')
				this.addModal = false
				this.data.tagName = ''
			}else{
				if(res.status==422){
		...
		async editAdmin(){
			...
			if(res.status===200){
				...
				this.s('User has been edited sucsefully!')
