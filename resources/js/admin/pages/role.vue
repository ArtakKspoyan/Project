        ...
        <div class="content">
			<div class="container">
				...
				<div class="_1adminOverveiw_table_recent _box_shadow _border_radious _mar_b30 _p20">
					<p class="_title0">Role Managment <Button @click="addModal = true"><Icon type="md-add" />Add a new role</Button></p>
	...
	methods : {
		async add(){
			...
			if(res.status===201){
				...
				this.s('Role has been added sucsefully!')
				this.addModal = false
				this.data. roleName = ''
			}else{
				if(res.status==422){
		...
		async edit(){
			...
			if(res.status===200){
				...
				this.s('Role name has been edited sucsefully!')
